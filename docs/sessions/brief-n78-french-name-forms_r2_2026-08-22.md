# BRIEF. N.78 research: the established French form of 62 names (r2, 2026-08-22: adds the BnF route and the memo name)
...
## The route, established by Code on 2026-08-21

`data.bnf.fr`'s search page is JavaScript-rendered and returns nothing to a
fetch. Use the SRU authority endpoint and the `ark:` record pages instead; both
return content. If the SRU endpoint fails for a name, fall to step 2 of the
order of resort and record that you did.

## Where the answer goes

Return the table and the three sections as one markdown file named
`memo-n78-french-name-forms_r1_2026-08-22.md`. Dann saves it beside this brief
in `docs/sessions/`. Nothing else is written anywhere.
