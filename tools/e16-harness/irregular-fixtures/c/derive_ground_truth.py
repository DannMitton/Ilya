#!/usr/bin/env python3
"""Mechanically derive harness-schema ground truth from fixture-c.musicxml.
...
This is the abstention fixture: no printed grouping numerals and no dotted
barlines exist in the source (confirmed by their absence from the XML, and
visually confirmed absent from the rendered page). No additive grouping
field is derivable, by design; only the standard measureDurations assertion
runs below.
"""
import json
...
SRC = "fixture-c.musicxml"
OUT = "fixture-c-ground-truth.json"
...
ground_truth = {
    "pieceId": "e16-irregular-fixture-c---no-printed-division",
    "sourceMusxPath": "fixture-c.musicxml (MusicXML source, this procurement; no .musx exists)",
