#!/usr/bin/env python3
"""Mechanically derive harness-schema ground truth from b3-ledger-lines-scale.musicxml.
...
SRC = "b3-ledger-lines-scale.musicxml"
OUT = "b3-ledger-lines-scale-ground-truth.json"
...
ground_truth = {
    "pieceId": "e16-fixture-b3---ledger-lines-scale-variant-150dpi",
    "sourceMusxPath": "b3-ledger-lines-scale.musicxml (MusicXML source, this procurement; no .musx exists)",
