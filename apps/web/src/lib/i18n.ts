...
const strings: Record<string, Record<Language, string>> = {
	...
	'insights.fit.colReference':   { en: 'Your reference range',         fr: 'Vos repères' },
	'insights.fit.colFlag':        { en: 'Flag',                         fr: 'Signalement' },
	'insights.fit.range':          { en: 'Range containment',            fr: 'Inclusion de l\u2019ambitus' },
	'insights.fit.crossings':      { en: 'Passaggio crossings',          fr: 'Croisements de passaggio' },
	'insights.fit.tessitura':      { en: 'Tessitura containment',        fr: 'Inclusion de la tessiture' },
	'insights.fit.compass':        { en: 'Compass {low} to {high}',      fr: 'Ambitus {low} à {high}' },
	'insights.fit.span':           { en: '{low} to {high}',              fr: '{low} à {high}' },
	'insights.fit.spanTyped':      { en: '{low} to {high}, typed',       fr: '{low} à {high}, indiqué' },
	'insights.fit.notTyped':       { en: 'Not typed',                    fr: 'Non indiqué' },
	'insights.fit.noPitches':      { en: 'No sung pitch',                fr: 'Aucune hauteur chantée' },
	'insights.fit.crossingsCount': { en: '{primo} of the primo, {secondo} of the secondo', fr: '{primo} du primaire, {secondo} du secondaire' },
	'insights.fit.crossingsUncounted': { en: 'Not counted without both passaggi', fr: 'Non comptés sans les deux passaggi' },
	'insights.fit.passaggiTyped':  { en: 'Primo {primo}, secondo {secondo}, typed', fr: 'Primaire {primo}, secondaire {secondo}, indiqués' },
	'insights.fit.tessituraFallback': { en: 'cut at half the second-longest pitch, because the published rule gave one note', fr: 'coupure à la moitié de la deuxième hauteur la plus longue, car la règle publiée n\u2019en donnait qu\u2019une' },
	'insights.fit.tessituraMarginal': { en: 'a pitch sits within half a quaver of the cut, so the band could move', fr: 'une hauteur se situe à moins d\u2019une demi-croche de la coupure, de sorte que la bande pourrait se déplacer' },
	'insights.fit.withheldOne':    { en: 'Not printed: measure {measures} does not add up to its time signature', fr: 'Non imprimé\u00a0: la mesure {measures} ne correspond pas à son chiffrage de mesure' },
	'insights.fit.withheldMany':   { en: 'Not printed: measures {measures} do not add up to their time signatures', fr: 'Non imprimé\u00a0: les mesures {measures} ne correspondent pas à leur chiffrage de mesure' },
	'insights.fit.nothingSung':    { en: 'Nothing sung to measure',      fr: 'Rien de chanté jusqu\u2019à la mesure' },
	'insights.flag.contained':     { en: 'Contained',                    fr: 'Inclus' },
	'insights.flag.above':         { en: 'Above',                        fr: 'Au-dessus' },
	...
	'insights.findings.heading':   { en: 'What is flagged, heaviest first', fr: 'Ce qui est signalé, du plus lourd au plus léger' },
	...
	'insights.findings.furtherOne': { en: '1 further instance, in the score.', fr: '1 autre occurrence, dans la partition.' },
	'insights.findings.furtherMany': { en: '{n} further instances, in the score.', fr: '{n} autres occurrences, dans la partition.' },
	'insights.findings.remainderOne': { en: '1 further finding, lighter by phonation mass, prints in full on page 2.', fr: '1 autre observation, plus légère en masse de phonation, imprimée en entier à la page 2.' },
	'insights.findings.remainderMany': { en: '{n} further findings, lighter by phonation mass, print in full on page 2.', fr: '{n} autres observations, plus légères en masse de phonation, imprimées en entier à la page 2.' },
	'insights.findings.deferredHeading': { en: 'The findings page one deferred', fr: 'Les observations reportées par la page 1' },
	'insights.finding.rangeAbove': { en: 'The note rises above the range you typed.', fr: 'La note monte au-dessus de l\u2019ambitus que vous avez indiqué.' },
	'insights.finding.rangeBelow': { en: 'The note drops below the range you typed.', fr: 'La note descend sous l\u2019ambitus que vous avez indiqué.' },
	...
	'insights.finding.tighten':    { en: 'The {vowel} at the top of your range and sustained here is an exposed spot where the vowel can tighten.', fr: 'Le {vowel}, au sommet de votre ambitus et tenu ici, est un endroit exposé où la voyelle peut se resserrer.' },
	'insights.finding.turnover':   { en: 'The {vowel} at the top of your range and sustained here is an exposed spot where the tone can spread or press.', fr: 'Le {vowel}, au sommet de votre ambitus et tenu ici, est un endroit exposé où le son peut s\u2019étaler ou se presser.' },
	'insights.finding.passaggio':  { en: 'This falls near your passaggio; expect the turn to want managing.', fr: 'Cela tombe près de votre passaggio; attendez-vous à devoir gérer le passage.' },
