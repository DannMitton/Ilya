...
const strings: Record<string, Record<Language, string>> = {
	...
	'profile.vowelSingular': { en: 'vowel', fr: 'vowel' },
	'profile.vowelPlural': { en: 'vowels', fr: 'vowels' },
	'profile.analysedClause': { en: ' with {count} {vowelWord} measured', fr: ' with {count} {vowelWord} measured' },
	...
	'profile.statusSet': { en: 'Your profile is now set{clause}.', fr: 'Your profile is now set{clause}.' },
	'profile.provisional.your': { en: 'Your', fr: 'Your' },
	'profile.provisional.isSingular': { en: 'is', fr: 'is' },
	'profile.provisional.isPlural': { en: 'are', fr: 'are' },
	'profile.provisional.afterIs': { en: 'provisional, and you can update', fr: 'provisional, and you can update' },
	'profile.provisional.thisValue': { en: 'this value', fr: 'this value' },
	'profile.provisional.theseValues': { en: 'these values', fr: 'these values' },
	'profile.provisional.tail': { en: 'anytime through the drawer on the left.', fr: 'anytime through the drawer on the left.' },
