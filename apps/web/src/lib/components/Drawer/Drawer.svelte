<script lang="ts">
	...
	function getParentIds(id: string | null): string[] {
		...
		if (['guide-what','guide-paste','guide-source','guide-ai','guide-role','guide-limits','guide-future','guide-fit-forecast','guide-fit-notation'].includes(id)) return ['guide-how'];
