<script lang="ts">
	...
	onMount(() => onready?.());
						...
						[ɑ].</p>
						<p><strong>мять → /matʲ/.</strong> Deux agents palatalisants, cette fois&#160;: ⟨я⟩ palatalise le ⟨м⟩, et ⟨ь⟩ palatalise le ⟨т⟩. La voyelle ⟨а⟩ est
						...
						<h4 id="learn-u3-note-o">A note on /o/</h4>
						<p>Grayson describes Russian /o/ as idiomatically a slight diphthong [oːʌ], the vowel releasing toward [ʌ], and after labial consonants a labialized [ʷoːʌ], but this specificity is never notated. Grayson simplifies it to /o/ in all transcriptions, and <em>Ilya</em> follows this convention. The singer should know that Russian /o/ is much looser than the German or French closed /o/, and much rounder than the Italian open /ɔ/, yet nowhere near the semi-open-o of French (i.e. 'sauvage'). It lives between these neighbours.</p>
