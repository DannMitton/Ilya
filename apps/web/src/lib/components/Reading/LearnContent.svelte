<script lang="ts">
	...
	let { language, onready }: Props = $props();
...
<h3 id="learn-unit-7">Section 7 · Assimilation et frontières</h3>
						...
						<!-- The note on /o/, expanded (Dann's copy, approved 2026-07-11;
						     Kimi ruling: beef up the existing note, no new chrome). The
						     anchor "learn-u3-note-o" is the target of the ⓘ glyph on the
						     calibration roster's [o] row. Grounded in Grayson (2012),
						     Appendix K, "The Story of /o/", pp. 359–397. -->
						<p id="learn-u3-note-o">A note on /o/. Grayson describes Russian /o/ as idiomatically a slight diphthong [oːʌ], the vowel releasing toward [ʌ], and after labial consonants a labialized [ʷoːʌ], but this specificity is never notated. Grayson simplifies it to /o/ in all transcriptions, and <em>Ilya</em> follows this convention. The singer should know that Russian /o/ is much looser than the German or French closed /o/, and much rounder than the Italian open /ɔ/, yet nowhere near the semi-open-o of French (i.e. 'sauvage'). It lives between these neighbours.</p>

						<p>Whether that vowel is open or closed has genuinely divided the authorities. Of the four standard guides to Russian lyric diction, two transcribe it /o/ and two /ɔ/, and the phoneticians fare no better: Daniel Jones placed it between half-close and half-open. Speech can hide the question inside the offglide; singing cannot, since a decision must be made about what the vowel is when it is sustained. Grayson's spectral analysis (Appendix K, 'The Story of /o/') shows why nobody could agree: the vowel behaves like closed /o/ in the lips and the back of the tongue, and like open /ɔ/ in the front of the tongue. Sung Russian /o/ is a fusion vowel: the lips of an Italianate closed /o/ over the tongue of an open /ɔ/. To find it, start from open /ɔ/ and slowly round the lips toward closed /o/, or start from closed /o/ and slowly lower the tongue.</p>

						<p>Grayson transcribes this phoneme as /o/ rather than /ɔ/ for a pedagogical reason: the sight of /ɔ/ invites a singer to widen the lips, which is exactly the wrong direction. A European closed /o/ still sounds more Russian than a wide-open /ɔ/; err on the side of too closed, never too open. And because Russian has only the one o-phoneme, with no closed/open pair to confuse as in Italian or French, the singer may shade it for beauty of tone, rounder or less round, tongue higher or lower, without sacrificing intelligibility, so long as it stays rounded and never relaxes toward /a/.</p>
